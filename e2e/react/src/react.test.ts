...
describe('React Applications', () => {
  ...
  describe('Crystal Supported Tests', () => {
    ...
    it('should be able to generate a react app + lib (with CSR and SSR)', async () => {
      ...
      runCLI(
        `generate @nx/react:app apps/${appName} --style=css --bundler=webpack --no-interactive --skipFormat`
      );
      runCLI(
  ...
  describe('Non-Crystal Tests', () => {
    ...
    it('should be able to use JS and JSX', async () => {
      ...
      runCLI(
        `generate @nx/react:app apps/${appName} --bundler=webpack --no-interactive --js --skipFormat`
      );
      runCLI(
